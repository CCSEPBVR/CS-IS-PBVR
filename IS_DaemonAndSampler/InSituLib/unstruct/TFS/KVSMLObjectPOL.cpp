 ...
 *
 *  $Id: KVSMLObjectPOL.cpp 602 2010-08-19 02:43:34Z naohisa.sakamoto $
 */
/****************************************************************************/
...
KVSMLObjectPOL::KVSMLObjectPOL( const std::string& filename )
{
...
KVSMLObjectPOL::KVSMLObjectPOL( const kvs::ValueArray<float> values_on_line, const kvs::ValueArray<float> x_axis,
 ...
 */
/*===========================================================================*/
KVSMLObjectPOL::~KVSMLObjectPOL( void )
{
}

const kvs::ValueArray<float>& KVSMLObjectPOL:: values_on_line( void ) const
{
    return( m_values_on_line );
}

const kvs::ValueArray<float>& KVSMLObjectPOL::x_axis( void ) const
{
    return( m_x_axis );
}

const kvs::ValueArray<bool>& KVSMLObjectPOL::mask( void ) const
{
    return( m_mask );
}


void KVSMLObjectPOL::setValuesOnLine( const kvs::ValueArray<float>& values_on_line )
{
    m_values_on_line = values_on_line;
}

void KVSMLObjectPOL::setXAxis( const kvs::ValueArray<float>& x_axis )
{
    m_x_axis = x_axis;
}

void KVSMLObjectPOL::setMask( const kvs::ValueArray<bool>& mask )
{
    m_mask = mask;
}
/*===========================================================================*/
 ...
 */
/*===========================================================================*/
const bool KVSMLObjectPOL::read( const std::string& filename )
{
 ...
 */
/*===========================================================================*/
const bool KVSMLObjectPOL::write( const std::string& filename )
{
 ...
 */
/*===========================================================================*/
std::ostream& operator <<( std::ostream& os, const KVSMLObjectPOL& rhs )
{
