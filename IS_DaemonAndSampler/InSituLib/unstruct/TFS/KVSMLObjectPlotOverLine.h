 ...
 */
/****************************************************************************/
#ifndef KVS__KVSML_OBJECT_POL_H_INCLUDE
#define KVS__KVSML_OBJECT_POL_H_INCLUDE
...
public:
    ...
    //KVSMLObjectPlotOverLine( const kvs::ValueArray<kvs::Real32> coords, const kvs::ValueArray<kvs::UInt8>  colors,
