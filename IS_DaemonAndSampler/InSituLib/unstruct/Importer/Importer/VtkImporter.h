...
//class VtkImporter : public pbvr::ImporterBase, public KvsObjectType_
{
public:
...
public:
    ...
    //kvs::ObjectBase* exec( const pbvr::FileFormatBase* file_format )
    {
        kvs::ImporterBase::setSuccess( false );
        //pbvr::ImporterBase::setSuccess( false );
        ...
        try
        {
            ...
            //pbvr::ImporterBase::setSuccess( true );
            return this;
        }
