...
//    void setVolume( const pbvr::StructuredVolumeObject* volume );
    ...
    void extractPlotLine( const kvs::StructuredVolumeObject* volume );
    ...
    void SetOffset(const kvs::Vector3f offset ) { m_offset.x() = offset.x(); m_offset.y() = offset.y(); m_offset.z() = offset.z();} 
protected:
