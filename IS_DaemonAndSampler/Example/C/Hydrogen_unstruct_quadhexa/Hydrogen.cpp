...
const kvs::Int32 num_element_node = 20;
const kvs::Int32 num_cell_per_cube = 1 ; //num of cell per 1cube
/*===========================================================================*/
/**
    ...
    for ( size_t z = 0; z < dim3-1; ++z )
    {
        for ( size_t y = 0; y < dim2-1; ++y )
        {
            for ( size_t x = 0; x < dim1-1; ++x )
            {
                ...
                const kvs::UInt64 local_halfpoint_vertex_index[12] =
                {
...
//                const kvs::UInt64 local_vertex_index[20] =
//                {
//                    vertex_index,
//                    vertex_index + 1,
//                    vertex_index + 2,
