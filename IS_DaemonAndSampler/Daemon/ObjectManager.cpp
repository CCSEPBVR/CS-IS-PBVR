...
const pbvr::ObjectBase::ObjectType ObjectManager::objectType( void ) const
{
 ...
 */
/*==========================================================================*/
int ObjectManager::insert( int parent_id, pbvr::ObjectBase* obj )
{
    obj->updateNormalizeParameters();
 ...
 */
/*==========================================================================*/
pbvr::ObjectBase* ObjectManager::object( void )
{
 ...
 */
/*==========================================================================*/
pbvr::ObjectBase* ObjectManager::object( int obj_id )
{
    /* Search the object which is specified by given object ID in the
     * object pointer map. If it isn't found, this method executes nothing.
     */
 ...
 */
/*==========================================================================*/
pbvr::ObjectBase* ObjectManager::object( std::string obj_name )
{
    ObjectMap::iterator map_id = m_object_map.begin();
    ObjectMap::iterator map_end = m_object_map.end();
 ...
 */
/*==========================================================================*/
pbvr::ObjectBase* ObjectManager::activeObject( void )
{
 ...
 */
/*==========================================================================*/
pbvr::ObjectBase* ObjectManager::get_control_target( void )
{
 ...
 */
/*==========================================================================*/
kvs::Vector3f ObjectManager::get_rotation_center( pbvr::ObjectBase* obj )
{
    /* 131017 removed
        if( this->isEnableAllMove() )
        {
