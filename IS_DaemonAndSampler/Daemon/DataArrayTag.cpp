...
const bool DataArrayTag::read_data( const size_t nelements, kvs::AnyValueArray* data )
{
    ...
    if ( m_file == "" )
    {
        ...
        if ( m_type == "char" )
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::Int8>( data, nelements, t ) )
            {
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::UInt8>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::Int16>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::UInt16>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::Int32>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::UInt32>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::Real32>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadInternalData<kvs::Real64>( data, nelements, t ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
    ...
    else
    {
        ...
        if ( m_type == "char" )
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::Int8>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::UInt8>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::Int16>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::UInt16>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::Int32>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::UInt32>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::Real32>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
        ...
        {
            if ( !pbvr::kvsml::DataArray::ReadExternalData<kvs::Real64>( data, nelements, filename, m_format ) )
            {
                kvsMessageError( "Cannot read the data array in <%s>.", tag_name.c_str() );
                return ( false );
            }
