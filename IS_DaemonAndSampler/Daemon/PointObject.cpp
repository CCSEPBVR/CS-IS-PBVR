 ...
 */
/*===========================================================================*/
const kvs::ValueArray<pbvr::FrequencyTable>& PointObject::getColorHistogram( void ) const
{
 ...
 */
/*===========================================================================*/
const kvs::ValueArray<pbvr::FrequencyTable>& PointObject::getOpacityHistogram( void ) const
{
