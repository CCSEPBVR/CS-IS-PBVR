 ...
 */
/*===========================================================================*/
jpv::ParticleTransferClientMessage::EquationToken convertToken( std::string expression )
{
...
void connect1()
{
    jpv::ParticleTransferClient client( "localhost", 60000 );
...
void connect2()
{
    ...
    message.m_camera = new kvs::Camera();//足りないかも
    message.m_message_size = message.byteSize();
    ...
    message.m_transfer_function[0].m_color_variable_min = 0;
    message.m_transfer_function[0].m_color_variable_max = 1;
    ...
    message.m_transfer_function[1].m_color_variable_min = 0;
    message.m_transfer_function[1].m_color_variable_max = 1;
    ...
    message.m_transfer_function[2].m_color_variable_min = 0;
    message.m_transfer_function[2].m_color_variable_max = 1;
    ...
    message.m_transfer_function[3].m_color_variable_min = 0;
    message.m_transfer_function[3].m_color_variable_max = 1;
    ...
    message.m_transfer_function[4].m_color_variable_min = 0;
    message.m_transfer_function[4].m_color_variable_max = 1;
    ...
    message.m_transfer_function[5].m_opacity_variable_min = 0;
    message.m_transfer_function[5].m_opacity_variable_max = 1;
    ...
    message.m_transfer_function[6].m_opacity_variable_min = 0;
    message.m_transfer_function[6].m_opacity_variable_max = 1;
    ...
    message.m_transfer_function[7].m_opacity_variable_min = 0;
    message.m_transfer_function[7].m_opacity_variable_max = 1;
    ...
    message.m_transfer_function[8].m_opacity_variable_min = 0;
    message.m_transfer_function[8].m_opacity_variable_max = 1;
    ...
    message.m_transfer_function[9].m_opacity_variable_min = 0;
    message.m_transfer_function[9].m_opacity_variable_max = 1;
