#ifndef EXTENDEDTRANSFERFUNCTIONMESSAGE_H
#define EXTENDEDTRANSFERFUNCTIONMESSAGE_H
...
public:
    ...
    /** 一次座標変換関数x */
    std::string m_x_coordinate_synthesis;
    /** 一次座標変換関数y */
    std::string m_y_coordinate_synthesis;
    /** 一次座標変換関数z */
    std::string m_z_coordinate_synthesis;
...
#endif // EXTENDEDTRANSFERFUNCTIONMESSAGE_H
