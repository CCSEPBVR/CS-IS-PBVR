    ...
    void evalArray( float *result, int array_size )
        {
            ...
            //debug << "expr = {" ;
            //for (int i=0; i<NUMVAR; i++) debug << expr[i] << ",";
            //std::cout <<debug.str() <<std::endl;  

            //std::stringstream debug1; 
            //debug1 << "name = {" ;
            //for (int i=0; i<NUMVAR; i++) debug1 << name[i] << ",";
            //std::cout <<debug1.str() << std::endl;  

            //std::stringstream debug2; 
            //debug2 << "value = {" ;
            //for (int i=0; i<NUMVAR; i++) debug2 << value[0][i] << ",";
            //std::cout <<debug2.str() << std::endl;  
            //
            //std::stringstream debug3; 
            //debug3 << "number = {" ;
            //for (int i=0; i<NUMVAR; i++) debug3 << number[i] << ",";
            //std::cout <<debug3.str()<< std::endl;  
