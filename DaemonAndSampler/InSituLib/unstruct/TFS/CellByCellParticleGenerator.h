    ...
    const float                  sampling_step )
{
    ...
    //std::cout << "sampling_volume_inverse = " << sampling_volume_inverse << ": subpixel_length = " << subpixel_length << ": object_depth = " << object_depth <<": sampling_step = " <<  sampling_step << std::endl;
