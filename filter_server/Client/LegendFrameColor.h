 ...
 */
/*****************************************************************************/
#ifndef PBVR__KVS__VISCLIENT__LGEND_FRAME_COLOR_H_INCLUDE
#define PBVR__KVS__VISCLIENT__LGEND_FRAME_COLOR_H_INCLUDE
 ...
 */
/*===========================================================================*/
class LegendFrameColor : public kvs::glut::Screen
{
    kvsClassName( kvs::visclient::LegendFrameColor );
...
public:
    ...
    LegendFrameColor( kvs::visclient::LegendpanelUI* parent = 0, kvs::ScreenBase* parent_screen = 0 );

    virtual ~LegendFrameColor();
...
#endif // PBVR__KVS__VISCLIENT__LGEND_FRAME_COLOR_H_INCLUDE
