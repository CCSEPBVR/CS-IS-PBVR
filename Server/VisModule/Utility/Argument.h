...
public:
    ...
    // jpv::DataDefines m_size_sampling_method; // ���n�_�Ή��̂��߈�U�R�����g�A�E�g
    std::vector<std::string> m_size_variable;
    // jpv::GlyphMode m_distribution_mode; // ���n�_�Ή��̂��߈�U�R�����g�A�E�g
    // jpv::DataDefines m_color_data_sampling_method; // ���n�_�Ή��̂��߈�U�R�����g�A�E�g
