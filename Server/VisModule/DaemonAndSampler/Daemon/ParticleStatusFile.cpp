...
void ParticleStatusFile::assign_name_list( const NameListFile& name_list_file )
{
    ...
    m_start_time_step  = nml.getValue<vismodule::UInt32>( "START_STEP" );
    m_latest_time_step = nml.getValue<vismodule::UInt32>( "LATEST_STEP" );
}
...
void ParticleStatusFile::read_name_list_file()
{
    ...
    if( nlfile.read() )
    {
        ...
        {
            const vismodule::UInt32 back_time_step = m_latest_time_step;
...
vismodule::UInt32 ParticleStatusFile::getLatestTimeStep()
{
    return m_latest_time_step;
}

vismodule::UInt32 ParticleStatusFile::getStartTimeStep()
{
