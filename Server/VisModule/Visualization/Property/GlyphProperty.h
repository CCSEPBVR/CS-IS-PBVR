...
struct GlyphProperty
{
    ...
    int32_t byteSize() const
    {
        ...
        size += vismodule::Serializer::byteSize( server_mode );
    ...
    size_t pack( char* buf ) const
    {
        ...
        index += vismodule::Serializer::write( buf + index, server_mode );
    ...
    size_t unpack( const char* buf )
    {
        ...
        index += vismodule::Serializer::read( buf + index, &server_mode );
    ...
    void show( int rank ) const
    {
        ...
        {
            server_mode_string = "CS";
        }
        else if ( server_mode == ServerMode::IS )
        {
            server_mode_string = "IS";
        }
        else
        {
            std::cout << "ERROR: unknown server mode" << std::endl;
            server_mode_string = "UNKNOWN";
        }
        ...
        std::cout << "server_mode                : " << server_mode_string                << std::endl;
