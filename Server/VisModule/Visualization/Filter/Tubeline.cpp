 ...
 *
 *  $Id: Tubeline.cpp 602 2010-08-19 02:43:34Z naohisa.sakamoto $
 */
/*****************************************************************************/
#include "Tubeline.h"
...
const vismodule::ValueArray<vismodule::Real32> GetVertexArray( const vismodule::LineObject& line )
{
    ...
    else if ( line.lineType() == vismodule::LineObject::Uniline )
    {
        ...
        const std::size_t nvertices = line.nconnections();
...
const vismodule::ValueArray<vismodule::UInt8> GetColorArray( const vismodule::LineObject& line )
{
    if ( line.ncolors() == 1 )
    {
        ...
        const std::size_t ncolors = line.nvertices();
...
const vismodule::ValueArray<vismodule::Real32> GetSizeArray( const vismodule::LineObject& line )
{
    if ( line.nsizes() == 1 )
    {
        ...
        const std::size_t nsizes = line.nvertices() - 1;
    ...
    const std::size_t con_id )
{
    ...
    const std::size_t nsizes = id2 - id1;
 ...
 */
/*===========================================================================*/
const std::size_t GetNumberOfVertices( const vismodule::LineObject& line )
{
 ...
 */
/*===========================================================================*/
void Tubeline::setNDivisions( const std::size_t ndivisions )
{
    m_ndivisions = ndivisions;
}
...
void Tubeline::filtering_polyline( const vismodule::LineObject& line )
{
    ...
    const std::size_t line_nconnections = line.nconnections();
    for( std::size_t i = 0, index = 0; i < line_nconnections; i++, index += 2 )
    {
        ...
        const std::size_t tmp_ncolors = ( color_type == vismodule::PolygonObject::VertexColor ) ?
            tmp_colors.size() :
