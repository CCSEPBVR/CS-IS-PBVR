 ...
 *
 *  $Id: MarchingHexahedra.cpp 602 2010-08-19 02:43:34Z naohisa.sakamoto $
 */
/****************************************************************************/
 ...
 */
/*===========================================================================*/
vismodule::ObjectBase* MarchingHexahedra::exec( const vismodule::ObjectBase& object )
{
 ...
 */
/*==========================================================================*/
void MarchingHexahedra::mapping( const vismodule::UnstructuredVolumeObject& volume )
{
...
/*==========================================================================*/
template <typename T>
void MarchingHexahedra::extract_surfaces( const vismodule::UnstructuredVolumeObject& volume )
{
...
/*==========================================================================*/
template <typename T>
const std::size_t MarchingHexahedra::calculate_table_index( const size_t* local_index ) const
{
...
/*==========================================================================*/
template <typename T>
const vismodule::Vector3f MarchingHexahedra::interpolate_vertex(
    const int vertex0,
...
/*==========================================================================*/
template <typename T>
const vismodule::RGBColor MarchingHexahedra::calculate_color( void )
{
