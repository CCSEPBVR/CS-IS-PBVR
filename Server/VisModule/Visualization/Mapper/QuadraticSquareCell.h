 ...
 */
/*****************************************************************************/
#ifndef VIS_MODULE__QUADRATIC_SQUARE_CELL_H_INCLUDE
#define VIS_MODULE__QUADRATIC_SQUARE_CELL_H_INCLUDE
...
/*===========================================================================*/
template <typename T>
class QuadraticSquareCell : public vismodule::CellBase<T>
{
    visModuleClassName( vismodule::QuadraticSquareCell );
...
public:
    ...
    QuadraticSquareCell( const vismodule::UnstructuredVolumeObject& volume );
...
#endif // VIS_MODULE__QUADRATIC_SQUARE_CELL_H_INCLUDE
