...
void PointObjectGenerator::GenerateParticleUnstruct(
    const Argument& param,
...
)
{
    ...
    */
    ...
    case 'u':
        std::cout << "Uniform sampling" << std::endl;
        vismodule::CellByCellUniformSampling sampler;
        sampler.sampling();
...
vismodule::PointObject* PointObjectGenerator::run( const Argument& param, const vismodule::Camera& camera, const int st )
{
...
vismodule::PointObject*  PointObjectGenerator::run( const Argument& param, const vismodule::Camera& camera, const int st, const int vl)
{
    this->setFilterInfo( m_mvp );
    this->setCoordSynthTS( st );
...
template <typename T>
void PointObjectGenerator::copy_values(
    vismodule::AnyValueArray& valueArray,
