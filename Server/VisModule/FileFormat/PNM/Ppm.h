 ...
 */
/****************************************************************************/
#ifndef VIS_MODULE__PPM_H_INCLUDE
#define VIS_MODULE__PPM_H_INCLUDE
 ...
 */
/*==========================================================================*/
class Ppm : public vismodule::FileFormatBase
{
    visModuleClassName( vismodule::Ppm );
...
#endif // VIS_MODULE__PPM_H_INCLUDE
