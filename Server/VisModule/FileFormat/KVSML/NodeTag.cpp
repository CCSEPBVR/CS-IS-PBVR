 ...
 */
/*===========================================================================*/
const bool NodeTag::read( const vismodule::XMLNode::SuperClass* parent )
{
    ...
    // nnodes="xxx"
    const std::string nnodes = vismodule::XMLElement::AttributeValue( element, "nnodes" );
    if ( nnodes != "" )
    {
        m_has_nnodes = true;
 ...
 */
/*===========================================================================*/
const bool NodeTag::write( vismodule::XMLNode::SuperClass* parent )
{
    const std::string tag_name = BaseClass::name();
    ...
    if ( m_has_nnodes )
    {
        ...
        const std::string value( vismodule::String( m_nnodes ).toStdString() );
