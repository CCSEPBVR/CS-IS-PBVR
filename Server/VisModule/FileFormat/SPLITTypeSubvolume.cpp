 ...
 */
/*===========================================================================*/
const vismodule::kvsml::KVSMLTag& SPLITTypeSubvolume::KVSMLTag() const
{
    return m_kvsml_tag;
}
 ...
 */
/*===========================================================================*/
const vismodule::kvsml::ObjectTag& SPLITTypeSubvolume::objectTag() const
{
    return m_object_tag;
}
 ...
 */
/*===========================================================================*/
const std::string& SPLITTypeSubvolume::cellType() const
{
    return m_cell_type;
}

const bool SPLITTypeSubvolume::hasLabel() const
{
    return m_has_label;
}

const std::string& SPLITTypeSubvolume::label() const
{
    return m_label;
}
...
const bool SPLITTypeSubvolume::hasMinValue() const
{
    return m_has_min_value;
}

const bool SPLITTypeSubvolume::hasMaxValue() const
{
    return m_has_max_value;
}

const double SPLITTypeSubvolume::minValue() const
{
    return m_min_value;
}

const double SPLITTypeSubvolume::maxValue() const
{
    return m_max_value;
}
 ...
 */
/*===========================================================================*/
const vismodule::AnyValueArray& SPLITTypeSubvolume::values() const
{
    return m_values;
}
 ...
 */
/*===========================================================================*/
const vismodule::ValueArray<vismodule::Real32>& SPLITTypeSubvolume::coords() const
{
    return m_coords;
}
 ...
 */
/*===========================================================================*/
const vismodule::ValueArray<vismodule::UInt32>& SPLITTypeSubvolume::connections() const
{
 ...
 */
/*===========================================================================*/
void SPLITTypeSubvolume::setWritingDataType( const WritingDataType& writing_type )
{
 ...
 */
/*===========================================================================*/
void SPLITTypeSubvolume::setCellType( const std::string& cell_type )
{
    m_cell_type = cell_type;
}

void SPLITTypeSubvolume::setLabel( const std::string& label )
{
    m_has_label = true;
    m_label = label;
}
...
void SPLITTypeSubvolume::setMinValue( const double min_value )
{
    m_has_min_value = true;
    m_min_value = min_value;
}

void SPLITTypeSubvolume::setMaxValue( const double max_value )
{
 ...
 */
/*===========================================================================*/
void SPLITTypeSubvolume::setValues( const vismodule::AnyValueArray& values )
{
    m_values = values;
}
 ...
 */
/*===========================================================================*/
void SPLITTypeSubvolume::setCoords( const vismodule::ValueArray<vismodule::Real32>& coords )
{
    m_coords = coords;
}
 ...
 */
/*===========================================================================*/
void SPLITTypeSubvolume::setConnections( const vismodule::ValueArray<vismodule::UInt32>& connections )
{
 ...
 */
/*===========================================================================*/
const bool SPLITTypeSubvolume::read( const std::string& filename )
{
    m_filename = filename;
    ...
    m_vector_length = value_tag.veclen();

    m_has_min_value = value_tag.hasMinValue();
    if ( m_has_min_value )
    {
        m_min_value = value_tag.minValue();
    }

    m_has_max_value = value_tag.hasMaxValue();
    if ( m_has_max_value )
    {
        m_max_value = value_tag.maxValue();
    }
 ...
 */
/*===========================================================================*/
const bool SPLITTypeSubvolume::write( const std::string& filename )
{
    m_filename = filename;
    ...
    vismodule::kvsml::ValueTag value_tag;
    value_tag.setVeclen( m_vector_length );

    if ( m_has_label )
    {
        value_tag.setLabel( m_label );
    }
    if ( m_has_min_value )
    {
 ...
 */
/*===========================================================================*/
const bool SPLITTypeSubvolume::CheckFileExtension( const std::string& filename )
{
 ...
 *  @param  filename [in] filename
 *  @return true, if the SPLITTypeSubvolume class can read the given file
 */
/*===========================================================================*/
const bool SPLITTypeSubvolume::CheckFileFormat( const std::string& filename )
{
    vismodule::XMLDocument document;
 ...
 */
/*===========================================================================*/
std::ostream& operator <<( std::ostream& os, const SPLITTypeSubvolume& rhs )
{
    os << "Cell type: " << rhs.m_cell_type << std::endl;
    os << "Veclen: " << rhs.m_vector_length << std::endl;
