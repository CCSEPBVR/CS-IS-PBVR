...
//    resolution = kvs::Vector3ui( 128, 128, 256 );
    resolution = kvs::Vector3ui( 128, 128, 128 );
...
//    cell_length = 127.f/(resolution.x()-1);
    ...
    global_region[ 0 ] = kvs::Vector2f(  0,  0 , 0  );
    global_region[ 1 ] = kvs::Vector2f( 63,  0 , 0  );
    global_region[ 2 ] = kvs::Vector2f( 63, 63 , 0  );
    global_region[ 3 ] = kvs::Vector2f(  0, 63 , 0  );
    global_region[ 4 ] = kvs::Vector2f(  0,  0 , 63  );
    global_region[ 5 ] = kvs::Vector2f( 63,  0 , 63  );
    global_region[ 6 ] = kvs::Vector2f( 63, 63 , 63  );
    global_region[ 7 ] = kvs::Vector2f(  0, 63 , 63  );
