...
const vismodule::Int32 num_element_node = 10;
const vismodule::Int32 num_cell_per_cube = 5 ; //num of cell per 1cube
/*===========================================================================*/
/**
    ...
    for ( std::size_t z = 0; z < dim3-1; ++z )
    {
        for ( std::size_t y = 0; y < dim2-1; ++y )
        {
            for ( std::size_t x = 0; x < dim1-1; ++x )
            {
                ...
                const vismodule::UInt64 local_halfpoint_vertex_index[18] =
                {
