...
public:
    ...
    float          cell_length;
    int            mpi_rank;
    int            member_id;   // ensemble member index (kd = 1 + member_id)
    bool           allocated;   // arrays allocated once (grid is fixed across members)
...
public:
    ...
    void set_member( int member );  // switch ensemble member and regenerate the field
