 ...
 * @param nvars
 */
void FilterIoPlot3d::plot3d_functionBlock_setDimension(Plot3DFunctionBlock* fBlock, int i, int j, int k, int nvars) {
 ...
 */
void FilterIoPlot3d::plot3d_functionBlock_allocateMemory(Plot3DFunctionBlock* fBlock, DataTypeId typeId) {
 ...
 * @param fBlock Plot3DFunctionGrid* the function grid instance to work on
 */
void FilterIoPlot3d::plot3d_functionBlock_deAllocateMemory(Plot3DFunctionBlock* fBlock) {
 ...
 * @return
 */
Int64 FilterIoPlot3d::plot3d_functionBlock_getDiskByteSize(Plot3DFunctionBlock* fBlock, GridFile* gFile) {
    Int64 byteSize;
    byteSize = 0;
 ...
 * @return
 */
int FilterIoPlot3d::plot3d_functionBlock_readWhole(Plot3DFunctionBlock* fBlock, GridFile* gFile) {
    int status = 0;
    int nx;
 ...
 * @return
 */
int FilterIoPlot3d::plot3d_functionBlock_readPlanes(Plot3DFunctionBlock* fBlock, GridFile* gFile) {
    int status = 0;
    int nx, k;
 ...
 * @param fBlock Plot3DFunctionGrid* the function grid instance to work on
 */
void FilterIoPlot3d::plot3d_functionBlock_writeToArray(Plot3DFunctionBlock* fBlock, int offset, int skip) {
    ...
    DataArray_copyAsFloat(&(fBlock->fValues), info->m_values, offset, skip);
};
 ...
 */
void FilterIoPlot3d::plot3d_functionBlock_dump(Plot3DFunctionBlock* fBlock, FILE* file) {
    int n, nx;
