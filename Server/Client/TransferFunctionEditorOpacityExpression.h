/*****************************************************************************/
/**
 *  @file   TransferFunctionEditorOpacityExpression.h
 ...
 *
 *  $Id: TransferFunctionEditorOpacityExpression.h 634 2010-10-13 07:04:05Z naohisa.sakamoto $
 */
/*****************************************************************************/
#ifndef PBVR__KVS__VISCLIENT__TRANSFER_FUNCTION_EDITOR_OPACITY_EXPRESSION_H_INCLUDE
#define PBVR__KVS__VISCLIENT__TRANSFER_FUNCTION_EDITOR_OPACITY_EXPRESSION_H_INCLUDE
 ...
 */
/*===========================================================================*/
class TransferFunctionEditorOpacityExpression : public kvs::glut::Screen
{
    kvsClassName( kvs::visclient::TransferFunctionEditorOpacityExpression );
...
protected:
    ...
    GLUI_EditText* m_glui_edit_tfa;

public:

    TransferFunctionEditorOpacityExpression( kvs::visclient::TransferFunctionEditorMain* parent = 0 );

    virtual ~TransferFunctionEditorOpacityExpression();
...
public:
    ...
    void equation( std::string* oe );

    void setEquation( const std::string& oe );

    void setOpacityMapEquation( const std::string& oe );
...
#endif // PBVR__KVS__VISCLIENT__TRANSFER_FUNCTION_EDITOR_OPACITY_EXPRESSION_H_INCLUDE
