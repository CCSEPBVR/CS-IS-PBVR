# PBVR Benchmark Report

This report is generated from existing PBVR timer CSV/log outputs. Parallel comparisons use the MPI max time, not only the average.
...
| --- | --- | --- | --- | --- | --- |
| 1 | async_io_wait | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=4.19483, contribution=0.302, max/avg=20.422 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | async_io_wait | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.39086, contribution=0.244, max/avg=14.628 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | async_io_wait | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.9137, contribution=0.281, max/avg=13.982 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | async_io_wait | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=5.074, contribution=0.365, max/avg=18.695 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | ensemble_generate_particles_total | large contribution | case=ens_Hydrogen_unstruct_mpi4, opt_max=13.9093, contribution=1.000, max/avg=1.000 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | ensemble_generate_particles_total | large contribution | case=ens_Hydrogen_unstruct_mpi4, opt_max=12.7319, contribution=0.915, max/avg=1.000 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | ensemble_generate_particles_total | large contribution; slower than serial section | case=ens_Hydrogen_unstruct_mpi4, opt_max=15.087, contribution=1.085, max/avg=1.000 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | ensemble_generate_particles_total | large contribution | case=ens_Hydrogen_unstruct_mpi4, opt_max=15.067, contribution=1.083, max/avg=1.000 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | final_barrier_state | communication/synchronization/io candidate; large contribution; needs review | case=ens_Hydrogen_unstruct_mpi4, opt_max=10.3565, contribution=0.745, max/avg=1.221 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | final_barrier_state | communication/synchronization/io candidate; large contribution; needs review | case=ens_Hydrogen_unstruct_mpi4, opt_max=8.66834, contribution=0.623, max/avg=1.295 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | final_barrier_state | communication/synchronization/io candidate; large contribution; needs review; slower than serial section | case=ens_Hydrogen_unstruct_mpi4, opt_max=10.8865, contribution=0.783, max/avg=1.216 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | final_barrier_state | communication/synchronization/io candidate; large contribution; needs review | case=ens_Hydrogen_unstruct_mpi4, opt_max=10.5776, contribution=0.760, max/avg=1.263 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | mpi_shift_size_exchange | communication/synchronization/io candidate; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.013469, contribution=0.001, max/avg=2.710 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | mpi_shift_size_exchange | communication/synchronization/io candidate; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.018457, contribution=0.001, max/avg=3.182 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | mpi_shift_size_exchange | communication/synchronization/io candidate; slower than serial section; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.138034, contribution=0.010, max/avg=9.810 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | mpi_shift_size_exchange | communication/synchronization/io candidate; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.021033, contribution=0.002, max/avg=3.217 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_coord_minmax | communication/synchronization/io candidate; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.000985, contribution=0.000, max/avg=30.425 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_coord_minmax | communication/synchronization/io candidate; slower than serial section; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.001356, contribution=0.000, max/avg=34.353 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_coord_minmax | communication/synchronization/io candidate; slower than serial section; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.001318, contribution=0.000, max/avg=34.508 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_coord_minmax | communication/synchronization/io candidate; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.001315, contribution=0.000, max/avg=34.404 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_history | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=6.15908, contribution=0.443, max/avg=11.166 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_history | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=6.49847, contribution=0.467, max/avg=13.649 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_history | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=7.58456, contribution=0.545, max/avg=15.665 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_history | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=8.19088, contribution=0.589, max/avg=15.139 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_ave | communication/synchronization/io candidate; slower than serial section; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=0.009601, contribution=0.001, max/avg=2.509 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_cov | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.49787, contribution=0.251, max/avg=3.959 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_cov | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.73571, contribution=0.269, max/avg=3.777 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_cov | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.65224, contribution=0.263, max/avg=3.862 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_cov | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=4.46478, contribution=0.321, max/avg=4.064 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_var | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.4977, contribution=0.251, max/avg=14.412 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_var | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.73552, contribution=0.269, max/avg=14.368 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_var | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.32578, contribution=0.239, max/avg=14.549 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | output_particles_var | communication/synchronization/io candidate; large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=4.4646, contribution=0.321, max/avg=14.897 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | sampling_prepare | strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=1.8e-05, contribution=0.000, max/avg=6.000 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | sampling_prepare | strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=1.9e-05, contribution=0.000, max/avg=5.897 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | sampling_prepare | strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=2.4e-05, contribution=0.000, max/avg=7.082 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | set_parameter_path | large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=2.40131, contribution=0.173, max/avg=5.336 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | set_parameter_path | large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=2.94499, contribution=0.212, max/avg=8.462 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | set_parameter_path | large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=2.90438, contribution=0.209, max/avg=6.459 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |
| 1 | set_parameter_path | large contribution; strong imbalance or wait | case=ens_Hydrogen_unstruct_mpi4, opt_max=3.37182, contribution=0.242, max/avg=6.641 | load imbalance, collective wait, rank-0 concentration, or expensive local kernel | inspect rank/thread raw timing and split compute/communication if the section remains dominant |

Showing first 40 of 115 rows.
