...
//    static void ScreenShotKeyFrame( kvs::Scene* scene, const int tstep );
    static void ScreenShot( kvs::oculus::jaea::Scene* scene, const int tstep );
    static void ScreenShotKeyFrame( kvs::oculus::jaea::Scene* scene, const int tstep );
