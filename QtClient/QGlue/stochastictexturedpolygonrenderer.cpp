...
bool HasConnections(const kvs::jaea::TexturedPolygonObject *texturedPolygon) {
  ...
  if (texturedPolygon->normalType() == kvs::jaea::TexturedPolygonObject::PolygonNormal) {
    has_connection = false;
  }
  if (texturedPolygon->colorType() == kvs::jaea::TexturedPolygonObject::PolygonColor) {
    has_connection = false;
  }
 ...
 */
/*===========================================================================*/
kvs::ValueArray<kvs::Real32> VertexCoords(const kvs::jaea::TexturedPolygonObject *texturedPolygon, const kvs::UInt32 texture_id,
 ...
 */
/*===========================================================================*/
kvs::ValueArray<kvs::Real32> VertexNormals(const kvs::jaea::TexturedPolygonObject *texturedPolygon, const kvs::UInt32 texture_id,
                                           const size_t nvertices) {
 ...
 */
/*===========================================================================*/
kvs::ValueArray<kvs::UInt8> VertexColors(const kvs::jaea::TexturedPolygonObject *texturedPolygon, const kvs::UInt32 texture_id,
                                         const size_t nvertices) {
  const size_t nfaces = texturedPolygon->numberOfConnections();
 ...
 */
/*===========================================================================*/
kvs::ValueArray<kvs::Real32> VertexTexture2DCoords(const kvs::jaea::TexturedPolygonObject *texturedPolygon, const kvs::UInt32 texture_id,
                                                   const size_t nvertices) {
  const size_t nfaces = texturedPolygon->numberOfConnections();
 ...
 */
/*===========================================================================*/
StochasticTexturedPolygonRenderer::StochasticTexturedPolygonRenderer() : StochasticRendererBase(new Engine()) {}
 ...
 */
/*===========================================================================*/
void StochasticTexturedPolygonRenderer::setPolygonOffset(const float offset) { static_cast<Engine &>(engine()).setPolygonOffset(offset); }
...
StochasticTexturedPolygonRenderer::Engine::Engine()
    : m_has_normal(false), m_has_connection(false), m_random_index(0), m_polygon_offset(0.0f), m_enabled_texture_linear(false),
      m_enabled_texture_mipmap(false), m_enabled_texture_mipmap_linear(false), m_enabled_texture_anisotropy(false) {}
...
void StochasticTexturedPolygonRenderer::Engine::create(kvs::ObjectBase *object, kvs::Camera *camera, kvs::Light *light) {
  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_1);
  kvs::jaea::TexturedPolygonObject *texturedPolygon = kvs::jaea::TexturedPolygonObject::DownCast(object);
  m_has_normal = (texturedPolygon->normals().size() > 0 && texturedPolygon->normalType() == kvs::jaea::TexturedPolygonObject::VertexNormal);
...

  {
    ...
    for (auto itr = mapIdToColorArray.begin(); itr != mapIdToColorArray.end(); itr++) {
      ...
      kvs::UInt32 width = mapIdToImageWidth[texture_id];
      kvs::UInt32 height = mapIdToImageHeight[texture_id];
      ...
      std::cout << "## "
                ...
                << "isBound=" << texture->isBound() << ", " << std::endl;
#endif // DEBUG_TEXTURED_POLYGON
      {
        // std::cout << "# " <<  std::endl;
  ...
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_1,
                                             "(A_6_1_2_5_5_3_1) class-kvs::StochasticTexturedPolygonRenderer::Engine::create create_texture_data",
                                             "(A_6_2_2_5_5_3_1) class-kvs::StochasticTexturedPolygonRenderer::Engine::create create_texture_data");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2);
  this->create_shader_program();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2, "(A_6_1_2_5_5_3_2)  create_shader_program",
                                             "(A_6_2_2_5_5_3_2)  create_shader_program");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_3);
  this->create_buffer_object(texturedPolygon);
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_3, "(A_6_1_2_5_5_3_3)  create_buffer_object",
                                             "(A_6_2_2_5_5_3_3)  create_buffer_object");
}
...
void StochasticTexturedPolygonRenderer::Engine::create_shader_program() {
  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2_1);
  kvs::ShaderSource::AddSearchPath(std::getenv("CGFORMAT_EXT4KVS_SHADER_DIR"));
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2_1, "(A_6_1_2_5_5_3_2_1)  ", "(A_6_2_2_5_5_3_2_1)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2_2);
...
#endif
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2_2, "(A_6_1_2_5_5_3_2_2)  read_shader_source",
                                             "(A_6_2_2_5_5_3_2_2)  read_shader_source");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2_3);
  if (isEnabledShading()) {
    switch (shader().type()) {
...
#endif // DEBUG_TEXTURED_POLYGON
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2_3, "(A_6_1_2_5_5_3_2_3)  ", "(A_6_2_2_5_5_3_2_3)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2_4);
  m_shader_program.build(vert, frag);
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2_4, "(A_6_1_2_5_5_3_2_4)  ", "(A_6_2_2_5_5_3_2_4)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_5_3_2_5);
  m_shader_program.bind();
  ...
  m_shader_program.unbind();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_5_3_2_5, "(A_6_1_2_5_5_3_2_5)  ", "(A_6_2_2_5_5_3_2_5)  ");
}
