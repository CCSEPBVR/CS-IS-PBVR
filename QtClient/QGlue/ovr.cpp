...
// const float OVRProjection_Far = 1000.0f;
// const float OVRProjection_Near = 0.2f;

bool Initialize() {

#ifdef DEBUG_SCREEN
  std::cout << "MSG kvs::jaea::pbvr::Initialize() called." << std::endl;
#endif // DEBUG_SCREEN
  ...
  std::cout << "Oculus initialized using SDK Version " << Version() << std::endl;
...
#ifdef DEBUG_SCREEN
  std::cout << "MSG kvs::jaea::pbvr::Shutdown() called." << std::endl;
#endif // DEBUG_SCREEN
...
#ifdef DEBUG_SCREEN
  std::cout << "MSG kvs::jaea::pbvr::Detect() called." << std::endl;
#endif // DEBUG_SCREEN
