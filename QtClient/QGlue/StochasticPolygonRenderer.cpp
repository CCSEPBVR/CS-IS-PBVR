...
size_t NumberOfVertices(const kvs::PolygonObject *polygon) {
  if (polygon->connections().size() > 0 &&
      (polygon->normalType() == kvs::PolygonObject::PolygonNormal || polygon->colorType() == kvs::PolygonObject::PolygonColor)) {
...
kvs::ValueArray<kvs::Real32> VertexNormals(const kvs::PolygonObject *polygon) {
  ...
  case kvs::PolygonObject::VertexNormal: {
    if (polygon->connections().size() > 0 && polygon->colorType() == kvs::PolygonObject::PolygonColor) {
      const size_t nfaces = polygon->numberOfConnections();
...
kvs::ValueArray<kvs::UInt8> VertexColors(const kvs::PolygonObject *polygon) {
  ...
  case kvs::PolygonObject::VertexColor: {
    if (polygon->connections().size() > 0 && polygon->normalType() == kvs::PolygonObject::PolygonNormal) {
      const size_t nfaces = polygon->numberOfConnections();
 ...
 */
/*===========================================================================*/
StochasticPolygonRenderer::StochasticPolygonRenderer() : StochasticRendererBase(new Engine()) {}
 ...
 */
/*===========================================================================*/
void StochasticPolygonRenderer::setPolygonOffset(const float offset) { static_cast<Engine &>(engine()).setPolygonOffset(offset); }
 ...
 */
/*===========================================================================*/
StochasticPolygonRenderer::Engine::Engine() : m_has_normal(false), m_has_connection(false), m_polygon_offset(0.0f) {}
...
#endif // ENABLE_SHADER_PROGRAM_RELEASE
...
void StochasticPolygonRenderer::Engine::create(kvs::ObjectBase *object, kvs::Camera *camera, kvs::Light *light) {
  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_1);
  ...
  attachObject(object);
  createRandomTexture();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_1,
                                             "(A_6_1_2_5_1_3_1) class-kvs::StochasticPolygonRenderer::Engine::create createRandomTexture",
                                             "(A_6_2_2_5_1_3_1) class-kvs::StochasticPolygonRenderer::Engine::create createRandomTexture");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_2);
  this->create_shader_program();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_2, "(A_6_1_2_5_1_3_2)  create_shader_program",
                                             "(A_6_2_2_5_1_3_2)  create_shader_program");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_3);
  this->create_buffer_object(polygon);
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_3, "(A_6_1_2_5_1_3_3)  create_buffer_object",
                                             "(A_6_2_2_5_1_3_3)  create_buffer_object");
}
...
void StochasticPolygonRenderer::Engine::create_shader_program() {
  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_2_1);
#ifdef ENABLE_LOAD_SHADER_STATIC
  static kvs::ShaderSource vert("SR_polygon.vert");
  static kvs::ShaderSource frag("SR_polygon.frag");
#else
  kvs::ShaderSource vert("SR_polygon.vert");
  kvs::ShaderSource frag("SR_polygon.frag");
#endif

  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_2_1, "(A_6_1_2_5_1_3_2_1)  read_shader_source",
                                             "(A_6_2_2_5_1_3_2_1)  read_shader_source");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_2_2);
  if (isEnabledShading()) {
    switch (shader().type()) {
  ...
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_2_2, "(A_6_1_2_5_1_3_2_2)  ", "(A_6_2_2_5_1_3_2_2)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_2_3);
#ifdef ENABLE_LOAD_SHADER_STATIC
  ...
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_2_3, "(A_6_1_2_5_1_3_2_3)  ", "(A_6_2_2_5_1_3_2_3)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_1_3_2_4);
  if (!isLinked) {
    m_shader_program.bind();
  ...
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_1_3_2_4, "(A_6_1_2_5_1_3_2_4)  ", "(A_6_2_2_5_1_3_2_4)  ");
}
...
void StochasticPolygonRenderer::Engine::create_buffer_object(const kvs::PolygonObject *polygon) {
  ...
  if (m_has_connection) {
    m_vbo_manager.setIndexArray(polygon->connections());
  }
