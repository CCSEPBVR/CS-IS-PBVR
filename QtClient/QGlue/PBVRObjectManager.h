...
*/
/*==========================================================================*/
class PBVRObjectManager : public kvs::ObjectBase
{
private:
...
private:
    PBVRObjectManager( const PBVRObjectManager& );
    PBVRObjectManager& operator =( const PBVRObjectManager& );
