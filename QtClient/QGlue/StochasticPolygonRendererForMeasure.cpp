    ...
    kvs::Light* light )
{
    ...
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_1);
#endif
    ...
    createRandomTexture();
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_1, "(A_1_2_4_1_6_1) class kvs::StochasticPolygonRenderer::Engine::create createRandomTexture", "(A_2_2_4_1_6_1) class kvs::StochasticPolygonRenderer::Engine::create createRandomTexture");
#endif

#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_2);
#endif
    this->create_shader_program();
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_2, "(A_1_2_4_1_6_2)   create_shader_program", "(A_2_2_4_1_6_2)   create_shader_program");
#endif

#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_3);
#endif
    this->create_buffer_object( polygon );
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_3, "(A_1_2_4_1_6_3)   create_buffer_object", "(A_2_2_4_1_6_3)   create_buffer_object");
#endif
}
...
{
#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_2_1);
#endif
...
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_2_1, "(A_1_2_4_1_6_2_1)   read_shader_source", "(A_2_2_4_1_6_2_1)   read_shader_source");
#endif

#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_2_2);
#endif
    if ( isEnabledShading() )
    {
        switch ( shader().type() )
...
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_2_2, "(A_1_2_4_1_6_2_2)   frag.define()", "(A_2_2_4_1_6_2_2)   frag.define()");
#endif

#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_2_3);
#endif
#ifdef ENABLE_LOAD_SHADER_STATIC
...
#endif
    if(!isLinked){
        //std::cout<< "m_shader_program.build for StochasticPolygonRendererForMeasure" << std::endl;
        m_shader_program.build( vert, frag );
    }
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_2_3, "(A_1_2_4_1_6_2_3)   m_shader_program.build()", "(A_2_2_4_1_6_2_3)   m_shader_program.build()");
#endif

#ifdef ENABLE_TIME_MEASURE
    MAKE_AND_START_TIMER(A_1or2_2_4_1_6_2_4);
#endif
    if(!isLinked){
        m_shader_program.bind();
...
#ifdef ENABLE_TIME_MEASURE
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_1or2_2_4_1_6_2_4, "(A_1_2_4_1_6_2_4)   m_shader_program.bind()", "(A_2_2_4_1_6_2_4)   m_shader_program.bind()");
#endif
}
