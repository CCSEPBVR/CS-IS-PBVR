...
ColorMapPalette::ColorMapPalette(QWidget *parent)
    : QGLUEBaseWidget(parent), m_color_palette(NULL), m_texture(this, 3 * sizeof(kvs::UInt8), "ColorMP m_texture"), m_resolution(256) {
 ...
 */
/*===========================================================================*/
const std::string &ColorMapPalette::caption(void) const { return (m_caption); }
 ...
 */
/*===========================================================================*/
const QRect &ColorMapPalette::palette(void) const { return (m_palette); }
 ...
 */
/*===========================================================================*/
void ColorMapPalette::setCaption(const std::string &caption) { m_caption = caption; }
 ...
 */
/*===========================================================================*/
void ColorMapPalette::setDrawingColor(const kvs::RGBColor &color) { m_drawing_color = color; }
 ...
 */
/*===========================================================================*/
void ColorMapPalette::attachColorPalette(const ColorPalette *palette) { m_color_palette = palette; }
 ...
 */
/*===========================================================================*/
void ColorMapPalette::detachColorPalette(void) { m_color_palette = NULL; }
...
void ColorMapPalette::mousePressEvent(QMouseEvent *event) {
  ...
  if (m_palette.contains(x, y, true) && m_editable && isVisible()) {
    ...
    if (m_color_palette)
      m_drawing_color = m_color_palette->color();
...
void ColorMapPalette::mouseMoveEvent(QMouseEvent *event) {
  if (m_palette_active && isVisible() && m_editable) {
    // Color map palette geometry.
    const int x0 = m_palette.x();
    const int x1 = m_palette.x() + m_palette.width();
    const int y0 = m_palette.y();
