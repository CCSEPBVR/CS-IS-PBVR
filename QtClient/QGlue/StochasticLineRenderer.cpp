 ...
 */
/*===========================================================================*/
StochasticLineRenderer::StochasticLineRenderer() : StochasticRendererBase(new Engine()) {}
 ...
 */
/*===========================================================================*/
void StochasticLineRenderer::setLineOffset(const float offset) { static_cast<Engine &>(engine()).setLineOffset(offset); }
 ...
 */
/*===========================================================================*/
void StochasticLineRenderer::setOpacity(const kvs::UInt8 opacity) { static_cast<Engine &>(engine()).setOpacity(opacity); }
 ...
 */
/*===========================================================================*/
StochasticLineRenderer::Engine::Engine() : m_line_opacity(255), m_has_connection(false), m_line_offset(0.0f) {}
...
void StochasticLineRenderer::Engine::create(kvs::ObjectBase *object, kvs::Camera *camera, kvs::Light *light) {
  MAKE_AND_START_TIMER(A_6_1or2_2_5_2_3_1);
  kvs::LineObject *line = kvs::LineObject::DownCast(object);
  kvs::LineObject::LineType type = line->lineType();
  m_has_connection = line->numberOfConnections() > 0 && (type == kvs::LineObject::Segment || type == kvs::LineObject::Uniline);

  attachObject(object);
  createRandomTexture();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_2_3_1, "(A_6_1_2_5_2_3_1)  createRandomTexture", "(A_6_2_2_5_2_3_1)  createRandomTexture");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_2_3_2);
  this->create_shader_program();
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_2_3_2, "(A_6_1_2_5_2_3_2)  ", "(A_6_2_2_5_2_3_2)  ");

  MAKE_AND_START_TIMER(A_6_1or2_2_5_2_3_3);
  this->create_buffer_object(line);
  STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_2_3_3, "(A_6_1_2_5_2_3_3)  ", "(A_6_2_2_5_2_3_3)  ");
}
...
void StochasticLineRenderer::Engine::create_shader_program() {
  ...
  if (name == OBJ_NAME_CONTROL_SPHERE) {
    MAKE_AND_START_TIMER(A_6_1or2_2_5_2_3_2_1);
...
#endif
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_2_3_2_1, "(A_6_1_2_5_2_3_2_1)  " + name, "(A_6_2_2_5_2_3_2_1)  " + name);

    MAKE_AND_START_TIMER(A_6_1or2_2_5_2_3_2_2);
    m_shader_program.build(vert, frag);
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_2_3_2_2, "(A_6_1_2_5_2_3_2_2)  " + name, "(A_6_2_2_5_2_3_2_2)  " + name);
  } else if (name == OBJ_NAME_BOUNDING_BOX) {
    MAKE_AND_START_TIMER(A_6_1or2_2_5_3_3_2_1);
#ifdef ENABLE_LOAD_SHADER_STATIC
    static kvs::ShaderSource vert("SR_line.vert");
    static kvs::ShaderSource frag("SR_line.frag");
#else
    ...
    kvs::ShaderSource frag("SR_line.frag");
#endif
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_3_3_2_1, "(A_6_1_2_5_3_3_2_1)  " + name, "(A_6_2_2_5_3_3_2_1)  " + name);

    MAKE_AND_START_TIMER(A_6_1or2_2_5_3_3_2_2);
    m_shader_program.build(vert, frag);
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_3_3_2_2, "(A_6_1_2_5_3_3_2_2)  " + name, "(A_6_2_2_5_3_3_2_2)  " + name);
  } else if (name == OBJ_NAME_BOUNDING_BOX_SUBMESH) {
    MAKE_AND_START_TIMER(A_6_1or2_2_5_4_3_2_1);
#ifdef ENABLE_LOAD_SHADER_STATIC
    static kvs::ShaderSource vert("SR_line.vert");
    static kvs::ShaderSource frag("SR_line.frag");
#else
    ...
    kvs::ShaderSource frag("SR_line.frag");
#endif
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_4_3_2_1, "(A_6_1_2_5_4_3_2_1)  " + name, "(A_6_2_2_5_4_3_2_1)  " + name);

    MAKE_AND_START_TIMER(A_6_1or2_2_5_4_3_2_2);
    m_shader_program.build(vert, frag);
    STOP_AND_RECORD_TIMER_WITH_ID_FOR_EACH_EYE(A_6_1or2_2_5_4_3_2_2, "(A_6_1_2_5_4_3_2_2)  " + name, "(A_6_2_2_5_4_3_2_2)  " + name);
  }
}
...
void StochasticLineRenderer::Engine::create_buffer_object(const kvs::LineObject *line) {
  ...
  if (m_has_connection) {
    m_vbo_manager.setIndexArray(line->connections());
  }
