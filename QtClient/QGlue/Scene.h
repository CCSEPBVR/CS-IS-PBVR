...
private:
  ...
  kvs::jaea::pbvr::ObjectManager *m_object_manager; ///< object manager
...
public:
  ...
  void updateXform();
  void updateXform(kvs::jaea::pbvr::ObjectManager *manager);
  ...
  kvs::jaea::pbvr::ObjectManager *objectManager() { return m_object_manager; }
  ...
  const kvs::jaea::pbvr::ObjectManager *objectManager() const { return m_object_manager; }
  ...
  void setScaleToObjectManager();
  kvs::Vec3 m_before_right;
  kvs::Vec3 m_current_glyph_pos;
...
#ifdef DISP_MODE_VR
  void threedcontrollerPressFunction(kvs::Vec3 hmdPos, kvs::Vec3 initialHmdPos, kvs::Vec3 hmdDir, kvs::Vec3 left_p, kvs::Vec3 right_p,
                                     kvs::Vec3 prev_left_p, kvs::Vec3 prev_right_p);
  void threedcontrollerReleaseFunction(kvs::Vec3 hmdPos, kvs::Vec3 initialHmdPos, kvs::Vec3 hmdDir, kvs::Vec3 left_p, kvs::Vec3 right_p,
                                       kvs::Vec3 prev_left_p, kvs::Vec3 prev_right_p);
  void glyphControllerPressFunction(kvs::Vec3 hmdPos, kvs::Vec3 initialHmdPos, kvs::Vec3 hmdDir, kvs::Vec3 left_p, kvs::Vec3 right_p,
                                    kvs::Vec3 prev_left_p, kvs::Vec3 prev_right_p);
  void glyphControllerReleaseFunction(kvs::Vec3 hmdPos, kvs::Vec3 initialHmdPos, kvs::Vec3 hmdDir, kvs::Vec3 left_p, kvs::Vec3 right_p,
                                      kvs::Vec3 prev_left_p, kvs::Vec3 prev_right_p);
  void setGuestGlyphPos();
#endif
