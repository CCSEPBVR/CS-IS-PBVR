...
//    }
    ...
    if (prev_val[0] != slider_val[0] ||
        ...
        std::cerr << "PBVRWidgetHandler::drawSlider() : call synchronizer." << std::endl;
        std::cerr << "  stepSize   = " << SliderControl::stepSize << std::endl;
        std::cerr << "  slider_min = " << slider_min << std::endl;
        std::cerr << "  slider_max = " << slider_max << std::endl;
        std::cerr << "  slider_val = " << slider_val[0] << " / " << slider_val[1] << " / " << slider_val[2] << std::endl;
        ...
        SliderSynchronizer::instance().synchronize(this, slider_min, slider_max, slider_val[0], slider_val[1], slider_val[2]);
    }
}
