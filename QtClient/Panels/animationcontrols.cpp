...
void AnimationControls::onEnableCaptureChanged(int index)
{
    ...
    {
        LogManager lg;
        lg.Write("animationcontrols.cpp",__func__,"applyButton",std::to_string(index));
    }
}
...
void AnimationControls::onImageFileChanged(const QString &arg1)
{
    ...
    {
        LogManager lg;
        lg.Write("animationcontrols.cpp",__func__,"imageName",animation_control_parameter.m_image_file);//caution by TO
    }
}
...
void AnimationControls::onAnimationFileChange(const QString &arg1)
{
    ...
    {
        LogManager lg;
        lg.Write("animationcontrols.cpp",__func__,"imageName",ValueKeyFrameFile);//caution by TO
    }
}
...
void AnimationControls::onInterpolationValueChanged(int arg1)
{
    ...
    {
        LogManager lg;
        lg.Write("animationcontrols.cpp",__func__,"KeyFrames",std::to_string(ValueNumKeyFrames));//caution by TO
    }
}

void AnimationControls::logPlay(std::string funcName,std::string str[])
{
    if(funcName.compare("onEnableCaptureChanged") == 0)
    {
        this->onEnableCaptureChanged(std::stoi(str[0]));
    }

    if(funcName.compare("onImageFileChanged") == 0)
    {
        this->onImageFileChanged(QString::fromStdString(str[0]));
    }

    if(funcName.compare("onAnimationFileChange") == 0)
    {
        this->onAnimationFileChange(QString::fromStdString(str[0]));
    }

    if(funcName.compare("onInterpolationValueChanged") == 0)
    {
        ui->totalKeyFrames->text().setNum(std::stoi(str[0]));
    }
}
