 ...
 */
/*===========================================================================*/
OpenXRScreen* OpenXRScreen::DownCast( kvs::ScreenBase* screen )
{
    return dynamic_cast<OpenXRScreen*>( screen );
}
 ...
 */
/*===========================================================================*/
const OpenXRScreen* OpenXRScreen::DownCast( const kvs::ScreenBase* screen )
{
    return dynamic_cast<OpenXRScreen*>( const_cast<kvs::ScreenBase*>( screen ) );
}
 ...
 */
/*===========================================================================*/
OpenXRScreen::OpenXRScreen( kvs::qt::Application* application, QWidget* parent ) :
    kvs::qt::ScreenBase( application, parent )
{
    kvsMessageDebug( "kvs::openxr::OpenXRScreen::Screen()" );
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setTitle( const std::string& title )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setPosition( const int x, const int y )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setSize( const int width, const int height )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setGeometry( const int x, const int y, const int width, const int height )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setBackgroundColor( const kvs::RGBColor& color )
{
    m_scene->background()->setColor( color );
}

void OpenXRScreen::setBackgroundColor( const kvs::RGBColor& color1, const kvs::RGBColor& color2 )
{
    m_scene->background()->setColor( color1, color2 );
}

void OpenXRScreen::setBackgroundImage( const kvs::ColorImage& image )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setControlTarget( const ControlTarget target )
{
    m_scene->controlTarget() = target;
}

void OpenXRScreen::setControlTargetToObject()
{
    this->setControlTarget( kvs::Scene::TargetObject );
}

void OpenXRScreen::setControlTargetToCamera()
{
    this->setControlTarget( kvs::Scene::TargetCamera );
}

void OpenXRScreen::setControlTargetToLight()
{
 ...
 */
/*===========================================================================*/
const std::pair<int, int> OpenXRScreen::registerObject( kvs::ObjectBase* object, kvs::RendererBase* renderer )
{
 ...
 */
/*===========================================================================*/
const std::pair<int, int> OpenXRScreen::registerObject( kvs::VisualizationPipeline* pipeline )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::setEvent( kvs::EventListener* event, const std::string& name )
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::addEvent( kvs::EventListener* event, const std::string& name )
{
    event->setScene( m_scene );
 ...
 */
/*===========================================================================*/
void OpenXRScreen::initializeEvent()
{
 ...
 */
/*===========================================================================*/
void OpenXRScreen::resizeEvent( int width, int height )
{
    this->setSize( width, height );
 ...
 */
/*===========================================================================*/
void OpenXRScreen::mousePressEvent( kvs::MouseEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::mouseMoveEvent( kvs::MouseEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::mouseReleaseEvent( kvs::MouseEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::mouseDoubleClickEvent( kvs::MouseEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::wheelEvent( kvs::WheelEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::keyPressEvent( kvs::KeyEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::keyRepeatEvent( kvs::KeyEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::keyReleaseEvent( kvs::KeyEvent* event )
{
    BaseClass::eventHandler()->notify( event );
}
 ...
 */
/*===========================================================================*/
void OpenXRScreen::controllerPressEvent( kvs::ControllerEvent* event )
{
    BaseClass::eventHandler()->notify( event );
 ...
 */
/*===========================================================================*/
void OpenXRScreen::controllerReleaseEvent( kvs::ControllerEvent* event )
{
    BaseClass::eventHandler()->notify( event );
    if ( m_openxr_interactor )
    {
 ...
 */
/*===========================================================================*/
void OpenXRScreen::controllerMoveEvent( kvs::ControllerEvent* event )
{
    BaseClass::eventHandler()->notify( event );
    if ( m_openxr_interactor )
    {
 ...
 */
/*===========================================================================*/
void OpenXRScreen::controllerAxisEvent( kvs::ControllerEvent* event )
{
    BaseClass::eventHandler()->notify( event );
    if ( m_openxr_interactor )
    {
 ...
 */
/*===========================================================================*/
GLuint OpenXRScreen::getDepthTexture( GLuint color_texture )
{
