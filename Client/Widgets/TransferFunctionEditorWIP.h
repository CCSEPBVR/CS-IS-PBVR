#ifndef TRANSFERFUNCTIONEDITORWIP_H
#define TRANSFERFUNCTIONEDITORWIP_H
...
namespace Ui {
class TransferFunctionEditorWIP;
}

class TransferFunctionEditorWIP : public QDialog
{
    Q_OBJECT

public:
    explicit TransferFunctionEditorWIP( WebSocketPair* websockets, QWidget *parent = nullptr );
    ~TransferFunctionEditorWIP();
...
private:
    ...
    VariableEditorWIP m_variable_editor_wip;
...
#endif // TRANSFERFUNCTIONEDITORWIP_H
