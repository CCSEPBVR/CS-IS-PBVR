...
TimeStepControlToolBarWIP::TimeStepControlToolBarWIP( WebSocketPair* websockets, QWidget* parent )
    : QToolBar( parent )
    ...
    , m_is_operator( false )
{
    ...
    connect( m_next_time_step_spin_box      , QOverload<int>::of( &QSpinBox::valueChanged ) , this, &TimeStepControlToolBarWIP::updateNext );
    connect( m_min_limit_time_step_spin_box , QOverload<int>::of( &QSpinBox::valueChanged ) , this, &TimeStepControlToolBarWIP::updateMinLimit );
    connect( m_max_limit_time_step_spin_box , QOverload<int>::of( &QSpinBox::valueChanged ) , this, &TimeStepControlToolBarWIP::updateMaxLimit );
    connect( m_update_interval_spin_box     , &QSpinBox::valueChanged                       , this, &TimeStepControlToolBarWIP::updateInterval );
    connect( &m_timer                       , &QTimer::timeout                              , this, &TimeStepControlToolBarWIP::updateTimeStep );
}

TimeStepControlToolBarWIP::~TimeStepControlToolBarWIP() {}

void TimeStepControlToolBarWIP::updateTotalTimeStepRange( int min, int max, bool isSingleObject )
{
...
void TimeStepControlToolBarWIP::onOperatorStateUpdate( bool operatorState )
{
...
void TimeStepControlToolBarWIP::first()
{
...
void TimeStepControlToolBarWIP::previous()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::reverse( bool isChecked )
{
    if( isChecked )
    {
...
void TimeStepControlToolBarWIP::play( bool isChecked )
{
    if( isChecked )
    {
...
void TimeStepControlToolBarWIP::next()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::last()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::keepLast( bool isChecked )
{
    if( isChecked )
    {
        m_is_last_mode = true;
...
void TimeStepControlToolBarWIP::jump()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::loop( bool isChecked )
{
    m_next_time_step_spin_box->setWrapping( isChecked );
}

void TimeStepControlToolBarWIP::loadParameter( const QString& filePath )
{
    // TODO:KPI
    qDebug() << __FILE__ << ":" << __func__ << ":" << filePath;
}

void TimeStepControlToolBarWIP::saveParameter( const QString& filePath )
{
    // TODO:KPI
    qDebug() << __FILE__ << ":" << __func__ << ":" << filePath;
}

void TimeStepControlToolBarWIP::decrementTimeStep()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::incrementTimeStep()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::keepLastTimeStep()
{
    if( m_is_merging ) return;
...
void TimeStepControlToolBarWIP::updateNext( int next )
{
...
void TimeStepControlToolBarWIP::updateMinLimit( int minLimit )
{
...
void TimeStepControlToolBarWIP::updateMaxLimit( int maxLimit )
{
    QMetaObject::invokeMethod( this, [=]() {
...
void TimeStepControlToolBarWIP::updateInterval()
{
    m_timer.setInterval( m_update_interval_spin_box->value() );
}

void TimeStepControlToolBarWIP::updateTimeStep()
{
