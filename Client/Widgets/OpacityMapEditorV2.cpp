#include "OpacityMapEditorV2.h"
#include "ui_OpacityMapEditorV2.h"

OpacityMapEditorV2::OpacityMapEditorV2(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::OpacityMapEditorV2)
...
OpacityMapEditorV2::~OpacityMapEditorV2()
{
    delete ui;
}

void OpacityMapEditorV2::setDefaultOpacityMap( const QVector<float>& opacities )
{
    m_default_opacities = opacities;
    ui->opacityMapPalette->setOpacities( opacities );
}

QVector<float> OpacityMapEditorV2::getOpacityMap()
{
    return ui->opacityMapPalette->getOpacities();
}

void OpacityMapEditorV2::initialize()
{
    ...
    connect( ui->resetPushButton, &QPushButton::clicked, this, &OpacityMapEditorV2::onReset );
    ...
    connect( ui->tabWidget, &QTabWidget::currentChanged, this, &OpacityMapEditorV2::onTabChanged );

    connect( ui->opacityLineEdit, &QLineEdit::textEdited, this, &OpacityMapEditorV2::onExpressionChanged );

    connect( ui->numberOfControlPointsSpinBox, &QSpinBox::valueChanged, this, &OpacityMapEditorV2::onNumberOfControlPointsChanged );
    connect( ui->controlPointsTableWidget, &QTableWidget::cellChanged, this, &OpacityMapEditorV2::onControlPointChanged );

    connect( ui->cancelPushButton, &QPushButton::clicked, this, &OpacityMapEditorV2::close );
    connect( ui->applyPushButton, &QPushButton::clicked, this, &OpacityMapEditorV2::accept );
}

void OpacityMapEditorV2::initializeExpression()
{
    ui->opacityLineEdit->setText( "x * 1" );
}

void OpacityMapEditorV2::initializeControlPoints()
{
...
void OpacityMapEditorV2::onReset()
{
    ui->opacityMapPalette->setOpacities( m_default_opacities );
}

void OpacityMapEditorV2::onTabChanged( int index )
{
    /*
     // * 0: Preset
     // * 1: Freeform Curve
...
void OpacityMapEditorV2::onExpressionChanged()
{
...
void OpacityMapEditorV2::onNumberOfControlPointsChanged( int value )
{
    ui->controlPointsTableWidget->setRowCount( value );
    onControlPointChanged();
}

void OpacityMapEditorV2::onControlPointChanged()
{
