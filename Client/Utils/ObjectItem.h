...
public:
    ...
    enum nameItemRole
    {
        ...
        TemporaryExtraOpacityFactor,           // エクストラオパシティファクター(未確定)
        CurrentExtraOpacityFactor,             // エクストラオパシティファクター(確定)
    ...
    QList<QStandardItem*> createItems() const
    {
        ...
        QVariant temporaryExtraOpacityFactor           = QVariant::fromValue( 1 );
        QVariant currentExtraOpacityFactor             = QVariant::fromValue( 1 );
        // テクスチャ無しポリゴンオブジェクト用
        ...
        nameItem->setData( temporaryExtraOpacityFactor         , nameItemRole::TemporaryExtraOpacityFactor );
        nameItem->setData( currentExtraOpacityFactor           , nameItemRole::CurrentExtraOpacityFactor );
