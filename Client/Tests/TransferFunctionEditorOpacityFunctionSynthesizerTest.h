#ifndef TRANSFERFUNCTIONEDITOROPACITYFUNCTIONSYNTHESIZERTEST_H
#define TRANSFERFUNCTIONEDITOROPACITYFUNCTIONSYNTHESIZERTEST_H
...
{
class OpacityFunctionSynthesizerTest : public QObject
{
    Q_OBJECT
...
private:
    ...
    struct ClientHandles
    {
        ...
        QComboBox* opacity_function_combo_box = nullptr;
    };

private slots:
    void initTestCase();
    void cleanupTestCase();
    void synthesize_opacity_functions();
...
private:
    ...
    bool connectClient( const ClientHandles& client ) const;
    void configureRemoteVisualization( const ClientHandles& client ) const;
    bool waitForObjectAndApply( const ClientHandles& client ) const;
    bool clickJumpAndWaitForCompletion( const ClientHandles& client ) const;
    void applyControlPointOpacityMap(
...
#endif // TRANSFERFUNCTIONEDITOROPACITYFUNCTIONSYNTHESIZERTEST_H
