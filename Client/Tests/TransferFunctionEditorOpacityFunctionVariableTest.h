#ifndef TRANSFERFUNCTIONEDITOROPACITYFUNCTIONVARIABLETEST_H
#define TRANSFERFUNCTIONEDITOROPACITYFUNCTIONVARIABLETEST_H
...
{
class OpacityFunctionVariableTest : public QObject
{
    Q_OBJECT
...
private:
    ...
    struct ClientHandles
    {
        ...
        QPushButton* opacity_function_variable_editor_button = nullptr;
        QLineEdit* opacity_function_variable_line_edit = nullptr;
    };

private slots:
    void initTestCase();
    void cleanupTestCase();
    void opacity_function_variable();
...
private:
    ...
    void editOpacityVariablesWithDialog(
...
#endif // TRANSFERFUNCTIONEDITOROPACITYFUNCTIONVARIABLETEST_H
