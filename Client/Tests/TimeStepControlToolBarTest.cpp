...
void TimeStepControlToolBarTest::startVideoRecording()
{
...
void TimeStepControlToolBarTest::initTestCase()
{
    ...
    m_video_file_path = QDir( m_output_dir_path ).absoluteFilePath( QStringLiteral( "TimeStepControlToolBarTest.mov" ) );
