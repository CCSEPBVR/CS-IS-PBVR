#ifndef TRANSFERFUNCTIONEDITOROPACITYMINMAXTEST_H
#define TRANSFERFUNCTIONEDITOROPACITYMINMAXTEST_H
...
{
class OpacityMinMaxTest : public QObject
{
    Q_OBJECT
...
private:
    ...
    struct ClientHandles
    {
        ...
        QRadioButton* opacity_user_defined_min_max_radio = nullptr;
        QRadioButton* opacity_server_side_min_max_radio = nullptr;
        QLineEdit* volume_data_path_line_edit = nullptr;
        QLineEdit* id_line_edit = nullptr;
        QLineEdit* object_name_line_edit = nullptr;
        QDoubleSpinBox* opacity_user_defined_min_spin_box = nullptr;
        QDoubleSpinBox* opacity_user_defined_max_spin_box = nullptr;
    };

private slots:
    void initTestCase();
    void cleanupTestCase();
    void opacity_min_max();
...
#endif // TRANSFERFUNCTIONEDITOROPACITYMINMAXTEST_H
