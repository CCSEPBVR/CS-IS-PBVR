#ifndef TRANSFERFUNCTIONEDITORCOLORMAPEDITTEST_H
#define TRANSFERFUNCTIONEDITORCOLORMAPEDITTEST_H
...
{
class ColorMapEditTest : public QObject
{
    Q_OBJECT
...
private:
    ...
    void doubleClickTrafficLightsStep( QDialog* dialog ) const;
    QVector<QColor> colorMapPaletteColors( QDialog* dialog ) const;
    void selectDrawingColor( QDialog* dialog, const QColor& color ) const;
    ...
    void runColorMapEditorScenario( const ClientHandles& client );
...
#endif // TRANSFERFUNCTIONEDITORCOLORMAPEDITTEST_H
