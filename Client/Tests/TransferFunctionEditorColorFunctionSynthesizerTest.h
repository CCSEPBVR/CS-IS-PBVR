#ifndef TRANSFERFUNCTIONEDITORCOLORFUNCTIONSYNTHESIZERTEST_H
#define TRANSFERFUNCTIONEDITORCOLORFUNCTIONSYNTHESIZERTEST_H
...
{
class ColorFunctionSynthesizerTest : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void synthesize_color_functions();
...
private:
    ...
    void applyControlPointColorMap( const ClientHandles& client, const QVector<QVector<double>>& rows );
...
#endif // TRANSFERFUNCTIONEDITORCOLORFUNCTIONSYNTHESIZERTEST_H
