#ifndef TRANSFERFUNCTIONEDITORCHANGETRANSFERFUNCTIONNUMBERTEST_H
#define TRANSFERFUNCTIONEDITORCHANGETRANSFERFUNCTIONNUMBERTEST_H
...
{
class ChangeTransferFunctionNumberTest : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void change_transfer_function_number();
...
private:
    ...
    void captureTransferFunctionNumberState(
...
#endif // TRANSFERFUNCTIONEDITORCHANGETRANSFERFUNCTIONNUMBERTEST_H
