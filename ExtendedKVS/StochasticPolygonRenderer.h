...
{
    kvsModule( kvs::mod::StochasticPolygonRenderer, Renderer );
...
public:
    ...
    using BufferObject = kvs::mod::glsl::PolygonRenderer::BufferObject;

    class RenderPass : public kvs::mod::glsl::PolygonRenderer::RenderPass
    {
    private:
        using BaseRenderPass = kvs::mod::glsl::PolygonRenderer::RenderPass;
