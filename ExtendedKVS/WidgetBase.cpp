 ...
 */
/*===========================================================================*/
kvs::qt::WidgetBase::WidgetBase( kvs::ScreenBase* screen ):
    m_parent( nullptr ),
    m_screen( screen ),
    m_painter(),
    m_margin( 0 ),
 ...
 */
/*===========================================================================*/
void kvs::qt::WidgetBase::setBackgroundOpacity( const float opacity )
{
 ...
 */
/*===========================================================================*/
void kvs::qt::WidgetBase::setBackgroundBorderOpacity( const float opacity )
{
...
void kvs::qt::WidgetBase::anchorToTop( const kvs::qt::WidgetBase* parent )
{
...
void kvs::qt::WidgetBase::anchorToBottom( const kvs::qt::WidgetBase* parent )
{
    switch ( parent->anchor() )
    {
    case Anchor::TopRight:
...
void kvs::qt::WidgetBase::anchorToLeft( const kvs::qt::WidgetBase* parent )
{
    switch ( parent->anchor() )
    {
...
void kvs::qt::WidgetBase::anchorToRight( const kvs::qt::WidgetBase* parent )
{
    switch ( parent->anchor() )
    {
    case Anchor::BottomLeft:
 ...
 */
/*===========================================================================*/
void kvs::qt::WidgetBase::hide()
{
    m_visible = false;
}

kvs::Vec2i kvs::qt::WidgetBase::anchorPosition()
{
    if ( m_parent )
    {
 ...
 */
/*==========================================================================*/
void kvs::qt::WidgetBase::drawBackground()
{
...
void kvs::qt::WidgetBase::initializeEvent()
{
    if ( Rectangle::width() == 0 ) Rectangle::setWidth( this->adjustedWidth() );
    if ( Rectangle::height() == 0 ) Rectangle::setHeight( this->adjustedHeight() );
