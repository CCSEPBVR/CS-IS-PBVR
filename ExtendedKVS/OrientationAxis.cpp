 ...
 */
/*===========================================================================*/
kvs::qt::OrientationAxis::OrientationAxis( kvs::ScreenBase* screen, const kvs::Scene* scene ):
    kvs::qt::WidgetBase( screen ),
    ...
    m_axis_type( kvs::qt::OrientationAxis::CorneredAxis ),
    m_box_type( kvs::qt::OrientationAxis::NoneBox ),
 ...
 */
/*===========================================================================*/
kvs::qt::OrientationAxis::OrientationAxis( kvs::ScreenBase* screen, const kvs::ObjectBase* object ):
    kvs::qt::WidgetBase( screen ),
    m_object( object ),
    m_x_tag( "X" ),
    m_y_tag( "Y" ),
 ...
 */
/*===========================================================================*/
kvs::qt::OrientationAxis::~OrientationAxis()
{
}
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::paintEvent()
{
    this->screenUpdated();
        ...
        kvs::OpenGL::WithPushedAttrib attrib( GL_ALL_ATTRIB_BITS );
        {
            ...
            p1.loadIdentity();
            {
                ...
                p2.loadIdentity();
                {
                    ...
                    switch ( m_box_type )
                    {
                    case kvs::qt::OrientationAxis::WiredBox: { this->draw_wired_box( length ); break; }
                    case kvs::qt::OrientationAxis::SolidBox: { this->draw_solid_box( length ); break; }
                    default: break;
                    }
                    ...
                    switch ( m_axis_type )
                    {
                    case kvs::qt::OrientationAxis::CorneredAxis: { this->draw_cornered_axis( length ); break; }
                    case kvs::qt::OrientationAxis::CenteredAxis: { this->draw_centered_axis( length ); break; }
                    default: break;
                    }
                }
            }
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::resizeEvent( int width, int height )
{
 ...
 */
/*===========================================================================*/
int kvs::qt::OrientationAxis::adjustedWidth()
{
 ...
 */
/*===========================================================================*/
int kvs::qt::OrientationAxis::adjustedHeight()
{
    return ::AxisWindowSize;
}
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::draw_centered_axis( const float length )
{
    const float x = 0.0f;
    const float y = 0.0f;
    const float z = 0.0f;
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::draw_cornered_axis( const float length )
{
    const float dpr = screen()->devicePixelRatio();
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::draw_wired_box( const float length )
{
    const float x = -length/2.0f;
    const float y = -length/2.0f;
    const float z = -length/2.0f;
    ...
    {
        if ( m_axis_type != kvs::qt::OrientationAxis::CorneredAxis )
        {
            // X axis.
            kvs::OpenGL::Vertices( v0, v1 );
        }
 ...
 */
/*===========================================================================*/
void kvs::qt::OrientationAxis::draw_solid_box( const float length )
{
    const float x = -length/2.0f;
    const float y = -length/2.0f;
    const float z = -length/2.0f;
