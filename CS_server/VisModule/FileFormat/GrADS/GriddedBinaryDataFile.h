 ...
 */
/*****************************************************************************/
#ifndef VIS_MODULE__GRADS__GRIDDED_BINARY_DATA_FILE_H_INCLUDE
#define VIS_MODULE__GRADS__GRIDDED_BINARY_DATA_FILE_H_INCLUDE
...
private:
    ...
    mutable vismodule::ValueArray<vismodule::Real32> m_values; ///< data values
...
public:
    ...
    const vismodule::ValueArray<vismodule::Real32>& values( void ) const;
...
#endif // VIS_MODULE__GRADS__GRIDDED_BINARY_DATA_FILE_H_INCLUDE
