...
ConnectionTag::ConnectionTag( void ):
    vismodule::kvsml::TagBase( "Connection" )
{
}
 ...
 */
/*===========================================================================*/
const bool ConnectionTag::read( const vismodule::XMLNode::SuperClass* parent )
{
 ...
 */
/*===========================================================================*/
const bool ConnectionTag::write( vismodule::XMLNode::SuperClass* parent )
{
    const std::string tag_name = BaseClass::name();
