...
// Visual Studio 2015
#elif ( _MSC_VER == 1900 )
#define VIS_MODULE_COMPILER_VERSION "14.00"
#define VIS_MODULE_COMPILER_VERSION_IS( major, minor ) ( 14 == ( major ) && 0 == ( minor ) )
#define VIS_MODULE_COMPILER_VERSION_LESS_THAN( major, minor ) \
...
// Visual Studio 2017
#elif ( _MSC_VER >= 1910 )
#define VIS_MODULE_COMPILER_VERSION "15.00"
#define VIS_MODULE_COMPILER_VERSION_IS( major, minor ) ( 15 == ( major ) && 0 == ( minor ) )
#define VIS_MODULE_COMPILER_VERSION_LESS_THAN( major, minor ) \
