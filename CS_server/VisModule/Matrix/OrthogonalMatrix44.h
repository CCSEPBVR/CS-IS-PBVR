 ...
 */
/*****************************************************************************/
#ifndef VIS_MODULE__ORTHOGONAL_MATRIX44_H_INCLUDE
#define VIS_MODULE__ORTHOGONAL_MATRIX44_H_INCLUDE
...
/*===========================================================================*/
template <typename T>
inline vismodule::Matrix44<T> OrthogonalMatrix44(
    const T left,
    const T right,
    const T bottom,
    const T top,
...
#endif // VIS_MODULE__ORTHOGONAL_MATRIX44_H_INCLUDE
