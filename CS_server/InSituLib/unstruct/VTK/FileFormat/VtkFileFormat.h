...
//class VtkFileFormat : public pbvr::FileFormatBase
{
public:
    /**
     * A base class type.
    ...
    //using BaseClass = pbvr::FileFormatBase;
    /**
...
public:
    ...
    //VtkFileFormat() noexcept: pbvr::FileFormatBase()
    {
    ...
    //VtkFileFormat( const std::string& filename ): pbvr::FileFormatBase()
    {
        set_reader_options = []( VtkReaderType* ) {};
        read( filename );
    }
    ...
    VtkFileFormat( const std::string& filename, ReaderOptionSetter reader_option_setter ):
        ...
        //pbvr::FileFormatBase(), set_reader_options( reader_option_setter )
    {
    ...
    //VtkFileFormat( vtkSmartPointer<VtkDataType> data ): pbvr::FileFormatBase() { vtk_data = data; }
    /**
     * Construct an IO object.
     *
    ...
    //VtkFileFormat( VtkDataType* data ): pbvr::FileFormatBase() { vtk_data = data; }
    virtual ~VtkFileFormat() {}

public:
    bool const  read( const std::string& filename ) override
...
//            return is_success;
    ...
    bool const  write( const std::string& filename ) override
