...
private:
   ...
   void  PointSampling_struct(const kvs::StructuredVolumeObject* object );
   //void  PointSampling_unstruct( );
   void  DistributionSampling(int number_of_sampling_point ,int seed, const kvs::VolumeObjectBase::CellType& celltype);
   void  DistributionSampling_struct(const kvs::StructuredVolumeObject* object);
...
//           unsigned int* connections, int ncells, const  pbvr::VolumeObjectBase::CellType& celltype); //ISPBVR
    GlyphGenerator(const kvs::StructuredVolumeObject& object ); 
    ...
    //GlyphGenerator(const jpv::ParticleTransferClientMessage& clntMes, const int number_of_divide,const kvs::StructuredVolumeObject& object ); 
    ~GlyphGenerator()
    {
    }
