...
## Package manager
CS-PBVRはパッケージマネージャーの**Homebrew**と**Spack**に対応している。
インストール方法・使用方法は[こちら](https://github.com/CCSEPBVR/CS-IS-PBVR/wiki/PackageManager_JP)。<br>
CS-PBVR is compatible with the **Homebrew** and **Spack** package managers.
Installation and usage instructions can be found [here](https://github.com/CCSEPBVR/CS-IS-PBVR/wiki/PackageManager_EN).
