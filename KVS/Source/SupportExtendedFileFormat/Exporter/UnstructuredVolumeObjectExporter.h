...
#include <kvs/extendedfileformat/KvsmlUnstructuredVolumeObject>
...
class UnstructuredVolumeObjectExporter : public kvs::ExporterBase,
                                         public kvs::ExtendedFileFormat::KvsmlUnstructuredVolumeObject
{
    kvsModule( kvs::ExtendedFileFormat::UnstructuredVolumeObjectExporter, Exporter );
