 ...
 */
#ifndef EXTENDED_FILE_FORMAT__STRUCTURED_VOLUME_OBJECT_EXPORTER_H_INCLUDE
#define EXTENDED_FILE_FORMAT__STRUCTURED_VOLUME_OBJECT_EXPORTER_H_INCLUDE
// clang-format off
...
#include <kvs/extendedfileformat/KvsmlStructuredVolumeObject>
...
class StructuredVolumeObjectExporter : public kvs::ExporterBase,
                                       public kvs::ExtendedFileFormat::KvsmlStructuredVolumeObject
{
    kvsModule( kvs::ExtendedFileFormat::StructuredVolumeObjectExporter, Exporter );
