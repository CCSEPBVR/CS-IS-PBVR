...
public:
     ...
     */
    kvs::ExtendedFileFormat::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType> eachPiece()
    {
        return kvs::ExtendedFileFormat::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType>(
     ...
     * \return An interface to iterate each piece.
     */
    kvs::ExtendedFileFormat::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType> eachPiece() const
    {
        return kvs::ExtendedFileFormat::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType>(
            m_number_of_pieces, reader );
    }
