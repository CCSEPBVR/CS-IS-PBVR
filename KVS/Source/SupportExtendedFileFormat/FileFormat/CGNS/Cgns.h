 ...
 */
#ifndef EXTENDED_FILE_FORMAT__CGNS_H_INCLUDE
#define EXTENDED_FILE_FORMAT__CGNS_H_INCLUDE
...
public:
     ...
     *
     * ```c++
     * kvs::ExtendedFileFormat::Cgns cgns;
     ...
     */
    kvs::ExtendedFileFormat::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet> eachBlock()
    {
        return kvs::ExtendedFileFormat::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet>( vtk_data );
    }
    /**
     * Get an interface to iterate each block.
     *
     ...
     * \return An interface to iterate.
     */
    kvs::ExtendedFileFormat::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet> eachBlock() const
    {
        return kvs::ExtendedFileFormat::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet>( vtk_data );
    }
