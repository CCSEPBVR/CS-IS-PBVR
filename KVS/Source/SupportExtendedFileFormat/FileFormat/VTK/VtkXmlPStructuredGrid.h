 ...
 */
#ifndef EXTENDED_FILE_FORMAT__VTK_XML_PSTRUCTURED_GRID_H_INCLUDE
#define EXTENDED_FILE_FORMAT__VTK_XML_PSTRUCTURED_GRID_H_INCLUDE
...
using VtkXmlPStructuredGrid =
    kvs::ExtendedFileFormat::ParallelVtkFileFormat<kvs::ExtendedFileFormat::VtkXmlStructuredGrid, vtkXMLPStructuredGridReader,
