 ...
 */
#ifndef EXTENDED_FILE_FORMAT_VTK_IMPORTER_H_INCLUDE
#define EXTENDED_FILE_FORMAT_VTK_IMPORTER_H_INCLUDE

#include "kvs/ImporterBase"
#include "kvs/Message"

#include <kvs/extendedfileformat/CvtTypeTraits>
 ...
 */
template <typename VtkFileFormat, typename KvsObjectType_ = typename kvs::ExtendedFileFormat::ConvertibleTypeTraits<
...
public:
    kvs::ObjectBase* exec( const kvs::FileFormatBase* file_format )
    {
        ...
        try
        {
            kvs::ExtendedFileFormat::Import<
                KvsObjectType*,
                vtkSmartPointer<typename kvs::ExtendedFileFormat::VtkFileFormatTraits<VtkFileFormat>::VtkDataType>>(
