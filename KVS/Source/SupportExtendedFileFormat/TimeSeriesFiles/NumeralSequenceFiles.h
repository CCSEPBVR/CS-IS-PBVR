...
public:
     ...
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat> begin()
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat>( filenames );
    }
    /**
     * Return a file format iterator to the beginning.
     *
     * \return A file format iterator.
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat> begin() const
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat>( filenames );
    }
    /**
     ...
     * \return A file format iterator.
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat> end()
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat>(
     ...
     * \return A file format iterator.
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat> end() const
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileIterator<FileFormat>(
            filenames, filenames->GetNumberOfValues() );
    }
 ...
 * kvs::ExtendedFileFormat::NumeralSequenceFiles<SomeFileFormat> n( pattern );
...
public:
     ...
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileContainer<FileFormat> eachTimeStep()
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileContainer<FileFormat>( filenames );
    }
    /**
     * Get an interface to iterate time series files.
     *
     * \return An interface to iterate time series files.
     */
    kvs::ExtendedFileFormat::detail::NumeralSequenceFileContainer<FileFormat> eachTimeStep() const
    {
        return kvs::ExtendedFileFormat::detail::NumeralSequenceFileContainer<FileFormat>( filenames );
    }
