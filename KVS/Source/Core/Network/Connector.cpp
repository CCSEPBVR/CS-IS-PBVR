 ...
 */
/*===========================================================================*/
Connector::Connector( const kvs::IPAddress& ip, const int port, const std::size_t ntrials )
{
 ...
 */
/*===========================================================================*/
bool Connector::connect( const kvs::IPAddress& ip, const int port, const std::size_t ntrials )
{
    m_ip      = ip;
    m_port    = port;
    m_ntrials = ntrials;
