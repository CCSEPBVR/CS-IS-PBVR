...
private:
    ...
    std::size_t m_scalar_resolution; ///< resolution of the scalar axis
    std::size_t m_depth_resolution; ///< resolution of the depth axis

public:

    PreIntegrationTable3D();
    PreIntegrationTable3D( const std::size_t scalar_resolution, const std::size_t depth_resolution );

    std::size_t scalarResolution() const { return m_scalar_resolution; }
    std::size_t depthResolution() const { return m_depth_resolution; }
    ...
    void setScalarResolution( const std::size_t scalar_resolution ) { m_scalar_resolution = scalar_resolution; }
    void setDepthResolution( const std::size_t depth_resolution ) { m_depth_resolution = depth_resolution; }
