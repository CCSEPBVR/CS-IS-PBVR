...
private:
    ...
    std::size_t m_ray_width = 1; ///< ray width
...
public:
    ...
    void enableLODControl( const std::size_t ray_width = 3 ) { m_enable_lod = true; m_ray_width = ray_width; }
...
public:
    KVS_DEPRECATED( void enableCoarseRendering( const std::size_t ray_width = 3 ) ) { m_ray_width = ray_width; }
