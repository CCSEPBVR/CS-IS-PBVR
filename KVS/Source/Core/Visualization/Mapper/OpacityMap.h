...
public:
    ...
    static kvs::OpacityMap DefaultOpacityMap( const std::size_t resolution = 256, const float max_opacity = 1.0f );

    static kvs::OpacityMap Constant( const std::size_t resolution = 256, const float max_opacity = 1.0f );
    static kvs::OpacityMap Linear( const std::size_t resolution = 256, const float max_opacity = 1.0f );
    static kvs::OpacityMap Gaussian( const std::size_t resolution = 256, const float max_opacity = 1.0f );
    static kvs::OpacityMap Gaussian( const std::size_t resolution, const float u, const float s, const float max_opacity = 1.0f );
...
public:
    OpacityMap() = default;
    explicit OpacityMap( const std::size_t resolution ): m_resolution( resolution ) {}
    ...
    OpacityMap( const std::size_t resolution, const Points& points );
    OpacityMap( const std::size_t resolution, const Points& points, const float min_value, const float max_value );
    OpacityMap( const std::size_t resolution, const std::list<float>& opacities );
    ...
    kvs::Real32 operator []( const std::size_t index ) const;
